...
Deja Vue creates a structured `.joker/` memory layer that records relevant project changes, decisions, context, and handoff notes so future agents can instantly understand the project as if they had worked on it before.
