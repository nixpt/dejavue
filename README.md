...
For the full design rationale — including the overlap with `.planning/`, hook
strategy, and the rejected-alternatives principle — see
`design_perspective.md` in this repo. For the build spec and migration path,
see `v0.1_scope.md`.
...
- `design_perspective.md` — design rationale, overlap analysis, hook strategy
